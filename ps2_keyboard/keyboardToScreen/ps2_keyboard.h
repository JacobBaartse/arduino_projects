//Works with HP fullsize ps2 keyboard.
...
void setup_ps2_keyboard()  {
    ...
    mySerial.begin(12600, SERIAL_8O1);  // depending on the keyboad the baud rate should be set to something between 10000 and 16600 bits per second.
